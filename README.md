# Lodgify coding challenge

This is my solution to the backend coding challenge.
How I managed to go through this project is described in the [Feedback page](Feedback.md)

Find below the original challenge instructions :  
